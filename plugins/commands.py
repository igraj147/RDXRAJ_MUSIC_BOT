...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            [
                InlineKeyboardButton('✨ Movie Update ✨', url='https://t.me/rdxraj_movie_update')
            ],
            [
                InlineKeyboardButton('⚡ Chatting Group  ⚡', url=f"https://t.me/THE_CRAZY_FUN_0"),
            ],
            [
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('⚡ Chatting Group ⚡', url=f"https://t.me/THE_CRAZY_FUN_0"),
            InlineKeyboardButton('✨ Movie Updates ✨', url='https://t.me/rdxraj_movie_update')
            ],[
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [InlineKeyboardButton('sᴜʙsᴄʀɪʙᴇ', url='https://youtube.com/@JOD_NATION?si=B5-cLH-JSMjpnR98')] ] ),
        protect_content=True if pre == 'filep' else False,
        )
